...
let Text = ({ children, variant = "sm", color = "#EBE9FC" }) => {
  return (
    <div>
      {variant === "xs" && (
        <div className={`font-['Comfortaa'] text-[12px] text-[#EBE9FC] lmao ${comfortaa.className}`}>
          {children}
        </div>
      )}
      {variant === "sm" && (
        <div className={`font-['Comfortaa'] text-[18px] text-[#EBE9FC] lmao ${comfortaa.className}`}>
          {children}
        </div>
      )}
      {variant === "md" && (
        <div className={`font-['Comfortaa'] text-[26px] text-[#EBE9FC] lmao ${comfortaa.className}`}>
          {children}
        </div>
      )}
      {variant === "heading" && (
