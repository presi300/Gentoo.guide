      ...
      <div className=" mt-[18vh] tall:mt-[30vh] short:bg-white  w-full">
          ...
          >
            <Link href="#1">
              <div className="bg-white bg-opacity-[3%] p-3 rounded-full text-center border-white border-opacity-5 border-[1px] hover:bg-opacity-[5%] transition-all">
                <Text variant="xs">{text.TitleButton.Text}</Text>
                <div className="w-full flex justify-center">
                  <div className="bg-white bg-opacity-5 rounded-full px-2">
                    <Text variant="xs">{text.TitleButton.ClickText}</Text>
                  </div>
                </div>
              </div>
            </Link>
        ...
        <div className="pt-[50vh] w-full sec2 pb-24 overflox-x-hidden">
          ...
          <div className="md:ml-12 text-center px-2 md:text-start md:px-0">
            <Text variant="heading">{text.secondTitle}</Text>
            <div className="flex flex-col gap-1 ">
              <Text variant="md">{text.secondSubTitle}</Text>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex w-full flex-col text-center  pr-12 pl-12">
              <Text variant="md">{text.Card1.Title}</Text>
              <Text variant="sm">{text.Card1.SubTitle}</Text>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 300 }}
          ...
          >
            <div className="flex w-full flex-col pl-12 pr-12">
              <Text variant="md">{text.Card2.Title}</Text>
              <Text variant="sm">{text.Card2.SubTitle}</Text>
            </div>
          ...
          >
            ...
            <div className="flex w-full flex-col text-center pr-12 pl-12">
              <Text variant="md">{text.Card3.Title}</Text>
              <Text variant="sm">{text.Card3.SubTitle}</Text>
            </div>
          </motion.div>
